...
ALTER TABLE IF EXISTS reports ADD COLUMN IF NOT EXISTS owner_note STRING;
ALTER TABLE IF EXISTS reports ADD COLUMN IF NOT EXISTS ai_override BOOLEAN;
ALTER TABLE IF EXISTS tickets ADD COLUMN IF NOT EXISTS due_day NUMBER;
ALTER TABLE IF EXISTS reports ADD COLUMN IF NOT EXISTS impact VARIANT;
